...
namespace Library
{
        ...
        static public bool ReadBool()
        {
            ...
            if (okay)
            {
                switch (char.ToUpper(s[0]))
                {
                    ...
                    default:
                        okay = false; b = false; inError = true;
    ...
    {   // 2015/06/18
        ...
        {
            // Closes this file
            // Unfortunately there seems no simple way to get the InFile to Close automatically
    ...
    {   // 2015/06/18
        ...
        public void WriteLine(char[] o, int off,
                              int len)
        { outWriter.Write(o, off, len); outWriter.WriteLine(); }
